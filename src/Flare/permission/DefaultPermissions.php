...
abstract class DefaultPermissions{
	...
	public static function registerCorePermissions(){
		$parent = self::registerPermission(new Permission(self::ROOT, "Allows using all Flare commands and utilities"));
		...
		$commands = self::registerPermission(new Permission(self::ROOT . ".command", "Allows using all Flare commands"), $parent);
