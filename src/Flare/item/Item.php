...
use Flare\block\Flower;
use Flare\entity\Entity;
use Flare\inventory\Fuel;
...
class Item{
	...
	private static function initCreativeItems($readFromJson = false){
		...
		if(!$readFromJson){
			...
			$creativeItems = new Config(Server::getInstance()->getFilePath() . "src/Flare/resources/creativeitems.json", Config::JSON, []);
