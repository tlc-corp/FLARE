...
namespace Flare\item\enchantment;

use Flare\item\ChainBoots;
use Flare\item\ChainChestplate;
use Flare\item\ChainHelmet;
use Flare\item\ChainLeggings;
use Flare\item\DiamondAxe;
use Flare\item\DiamondBoots;
use Flare\item\DiamondChestplate;
use Flare\item\DiamondHelmet;
use Flare\item\DiamondHoe;
use Flare\item\DiamondLeggings;
use Flare\item\DiamondPickaxe;
use Flare\item\DiamondShovel;
use Flare\item\DiamondSword;
use Flare\item\GoldAxe;
use Flare\item\GoldBoots;
use Flare\item\GoldChestplate;
use Flare\item\GoldHelmet;
use Flare\item\GoldHoe;
use Flare\item\GoldLeggings;
use Flare\item\GoldPickaxe;
use Flare\item\GoldShovel;
use Flare\item\GoldSword;
use Flare\item\IronAxe;
use Flare\item\IronBoots;
use Flare\item\IronChestplate;
use Flare\item\IronHelmet;
use Flare\item\IronHoe;
use Flare\item\IronLeggings;
use Flare\item\IronPickaxe;
use Flare\item\IronShovel;
use Flare\item\IronSword;
use Flare\item\Item;
use Flare\item\LeatherBoots;
use Flare\item\LeatherCap;
use Flare\item\LeatherPants;
use Flare\item\LeatherTunic;
use Flare\item\StoneAxe;
use Flare\item\StoneHoe;
use Flare\item\StonePickaxe;
use Flare\item\StoneShovel;
use Flare\item\StoneSword;
use Flare\item\WoodenAxe;
use Flare\item\WoodenHoe;
use Flare\item\WoodenPickaxe;
use Flare\item\WoodenShovel;
use Flare\item\WoodenSword;
