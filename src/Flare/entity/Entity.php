...
use Flare\block\Fire;
use Flare\block\Portal;
use Flare\block\PressurePlate;
use Flare\block\Water;
use Flare\event\entity\EntityDamageEvent;
use Flare\event\entity\EntityDespawnEvent;
use Flare\event\entity\EntityLevelChangeEvent;
use Flare\event\entity\EntityMotionEvent;
use Flare\event\entity\EntityRegainHealthEvent;
use Flare\event\entity\EntitySpawnEvent;
use Flare\event\entity\EntityTeleportEvent;
...
use Flare\Server;
use Flare\utils\ChunkException;
...
abstract class Entity extends Location implements Metadatable{
	...
	/** @var \Flare\event\TimingsHandler */
	protected $timings;
