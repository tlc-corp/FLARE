...
class WhitelistCommand extends VanillaCommand{
	...
	public function __construct($name){
		parent::__construct(
			$name,
			"%Flare.command.whitelist.description",
			"%commands.whitelist.usage",
			["wl"]
		);
		$this->setPermission("Flare.command.whitelist.reload;Flare.command.whitelist.enable;Flare.command.whitelist.disable;Flare.command.whitelist.list;Flare.command.whitelist.add;Flare.command.whitelist.remove");
	}
	...
	private function badPerm(CommandSender $sender, $perm){
		if(!$sender->hasPermission("Flare.command.whitelist.$perm")){
