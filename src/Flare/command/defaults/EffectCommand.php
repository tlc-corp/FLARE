...
use Flare\entity\InstantEffect;
...
class EffectCommand extends VanillaCommand{
	...
	public function __construct($name){
		parent::__construct(
			$name,
			"%Flare.command.effect.description",
			"%commands.effect.usage"
		);
		$this->setPermission("Flare.command.effect;Flare.command.effect.other");
	}
	...
	public function execute(CommandSender $sender, $currentAlias, array $args){
		...
		if($player->getName()!=$sender->getName() && !$sender->hasPermission("Flare.command.effect.other")){
