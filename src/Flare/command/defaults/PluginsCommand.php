...
class PluginsCommand extends VanillaCommand{
	...
	public function __construct($name){
		parent::__construct(
			$name,
			"%Flare.command.plugins.description",
			"%Flare.command.plugins.usage",
			["pl"]
		);
		$this->setPermission("Flare.command.plugins");
	}
	...
	private function sendPluginList(CommandSender $sender){
		...
		$sender->sendMessage(new TranslationContainer("Flare.command.plugins.success", [count($plugins), $list]));
	}
}
