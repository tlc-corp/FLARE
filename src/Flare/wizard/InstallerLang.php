...
class InstallerLang{
	...
	public function __construct($lang = ""){
		if(file_exists(\Flare\PATH . "src/Flare/lang/Installer/" . $lang . ".ini")){
			$this->lang = $lang;
			$this->langfile = \Flare\PATH . "src/Flare/lang/Installer/" . $lang . ".ini";
		}else{
			$files = [];
			foreach(new \DirectoryIterator(\Flare\PATH . "src/Flare/lang/Installer/") as $file){
			...
			if(count($files) > 0){
				...
				$this->langfile = \Flare\PATH . "src/Flare/lang/Installer/" . $l . ".ini";
			}else{
				$this->lang = "en";
				$this->langfile = \Flare\PATH . "src/Flare/lang/Installer/eng.ini";
			}
		}

		$this->loadLang(\Flare\PATH . "src/Flare/lang/Installer/eng.ini", "eng");
		if($this->lang !== "en"){
